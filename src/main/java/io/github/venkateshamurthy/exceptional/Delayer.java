...
public enum Delayer implements BiFunction<Duration, Duration, IntervalFunction> {
    ...
    /**
     * A convenient function to obtain {@link IntervalFunction} in minutes preferably fractional minutes
     *
     * @param initial  a double quantity that can represent decimal/fractional minutes
     * @param maxDelay a double quantity that can represent decimal/fractional minutes
     * @return an {@link IntervalFunction} in terms of minutes applying initial and max delays
     */
