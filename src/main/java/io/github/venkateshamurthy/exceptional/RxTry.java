...
public class RxTry {
     ...
     * @param <R>             type of result
     * @return Try wrapping checkedSupplier
     */
    ...
    /**
     * Wrapping {@link Runnable} with q {@link Try}
     *
     * @param runnable to be wrapped
     * @return Try wrapping runnable
     */
    ...
    /**
     * Wrapping {@link CheckedRunnable} with q {@link Try}
     *
     * @param runnable to be wrapped
     * @return Try wrapping runnable
     */
